...
var trak=function(){"use strict";var e=function(e){return e?trak.options.clean?r.call(this,e).toString().replace(/\s|'|"/g,o.delimeter).toLowerCase():r.call(this,e):""},t=function(t){var a=i(t),n=e.call(this,a.category),r=e.call(this,a.action),c=e.call(this,a.label),l=a.eventName,d=a.value,u=a.nonInteraction;"ga"===o.trackType&&"undefined"!=typeof ga?ga("send","event",n,r,c,d,{nonInteraction:u}):"_gaq"===o.trackType&&"undefined"!=typeof _gaq?_gaq.push(["_trackEvent",n,r,c,d]):"gtm"===o.trackType&&"undefined"!=typeof dataLayer&&dataLayer.push({event:l,eventCategory:n,eventAction:r,eventLabel:c,eventValue:d}),void 0!==o.additionalTypes&&o.additionalTypes(),o.debug&&console.debug("Debug message:\n Category:",n,"\n Action:",r,"\n Label:",c)},a=function(){var e=null!==this.getAttribute("data-trakwithjs")?!0:!1;e||n.call(this)},n=function(){var e=JSON.parse(this.getAttribute("data-trak"));t.call(this,e)},r=function(e){var t;switch(e){case"page.title":t=document.title;break;case"page.href":t=window.location.href;break;case"link.href":t=this.href;break;case"link.title":t=this.title;break;case"referrer":t=document.referrer?document.referrer:"No referrer";break;default:t=e}return t},i=function(e){return{category:e&&e.category||"",action:e&&e.action||"",label:e&&e.label||"",value:e&&e.value||0,nonInteraction:e&&e.nonInteraction||!1,eventName:e&&e.eventName||void 0}},o={clean:!0,delimeter:"_",trackType:"ga",additionalTypes:void 0,debug:!1},c=function(){for(var e=document.querySelectorAll("[data-trak]"),t=0;t<e.length;t++)e[t].addEventListener?e[t].addEventListener("click",a):e[t].attachEvent&&e[t].attachEvent("onclick",a)};return{start:c,clean:e,event:t,attrEvent:n,wildcard:r,options:o}}();"undefined"!=typeof define&&define.amd?define(function(){"use strict";return trak}):"undefined"!=typeof module&&module.exports?module.exports=trak:window.trak=trak;
