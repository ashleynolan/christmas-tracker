...
var UI=require("./ui"),Sockets={socket:null,init:function(){this.makeSocketConnection(),this.Listeners.setup()},makeSocketConnection:function(){var e=window.location.hostname;this.socket=io.connect(e)},Listeners:{setup:function(){Sockets.socket.on("tweet",this.onTweetReceived)},onTweetReceived:function(e){for(var t in e)UI.updateSymbol(t,e[t])}}};module.exports=Sockets;
