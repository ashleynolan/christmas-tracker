...
var UI=require("./ui"),Sockets={socket:null,init:function(){this.makeSocketConnection(),this.Listeners.setup()},makeSocketConnection:function(){var e=window.location.hostname;this.socket=io.connect(e)},Listeners:{setup:function(){Sockets.socket.on("tweet",this.onTweetReceived),Sockets.socket.on("state",this.onStateReceived)},onTweetReceived:function(e){UI.updateSymbol(e.key,e.symbol)},onStateReceived:function(e){for(var t in e)UI.updateSymbol(t,e[t]);UI.updateRankings(e)}}};module.exports=Sockets;
